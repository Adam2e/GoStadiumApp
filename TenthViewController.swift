...
class TenthViewController: ViewController{
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/cup/sinister")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "SinisterImage1")
        defaults.set(pokemonText2.text!, forKey: "SinisterImage2")
        defaults.set(pokemonText3.text!, forKey: "SinisterImage3")
        defaults.set(pokemonText4.text!, forKey: "SinisterImage4")
        defaults.set(pokemonText5.text!, forKey: "SinisterImage5")
        defaults.set(pokemonText6.text!, forKey: "SinisterImage6")
