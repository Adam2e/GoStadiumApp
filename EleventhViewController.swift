...
//  NewSideProject
//
//  Created by  on 10/14/19.
//  Copyright © 2019 2EApps. All rights reserved.
//

import UIKit

class EleventhViewController: ViewController{
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/cup/ferocious")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "FerociousImage1")
        defaults.set(pokemonText2.text!, forKey: "FerociousImage2")
        defaults.set(pokemonText3.text!, forKey: "FerociousImage3")
        defaults.set(pokemonText4.text!, forKey: "FerociousImage4")
        defaults.set(pokemonText5.text!, forKey: "FerociousImage5")
        defaults.set(pokemonText6.text!, forKey: "FerociousImage6")
