...
class SevenViewController: ViewController {
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/rainbow-cup")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "RainbowImage1")
        defaults.set(pokemonText2.text!, forKey: "RainbowImage2")
        defaults.set(pokemonText3.text!, forKey: "RainbowImage3")
        defaults.set(pokemonText4.text!, forKey: "RainbowImage4")
        defaults.set(pokemonText5.text!, forKey: "RainbowImage5")
        defaults.set(pokemonText6.text!, forKey: "RainbowImage6")
