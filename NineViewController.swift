...
class NineViewController: ViewController, UITextFieldDelegate {
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/season-1-regionals")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "RegionalImage1")
        defaults.set(pokemonText2.text!, forKey: "RegionalImage2")
        defaults.set(pokemonText3.text!, forKey: "RegionalImage3")
        defaults.set(pokemonText4.text!, forKey: "RegionalImage4")
        defaults.set(pokemonText5.text!, forKey: "RegionalImage5")
        defaults.set(pokemonText6.text!, forKey: "RegionalImage6")
