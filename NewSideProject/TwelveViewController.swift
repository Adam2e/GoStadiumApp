...
class TwelveViewController: ViewController{
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/cup/timeless")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "TimelessImage1")
        defaults.set(pokemonText2.text!, forKey: "TimelessImage2")
        defaults.set(pokemonText3.text!, forKey: "TimelessImage3")
        defaults.set(pokemonText4.text!, forKey: "TimelessImage4")
        defaults.set(pokemonText5.text!, forKey: "TimelessImage5")
        defaults.set(pokemonText6.text!, forKey: "TimelessImage6")
