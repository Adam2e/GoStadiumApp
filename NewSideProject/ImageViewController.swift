...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/boulder-cup")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "BoulderImage1")
        defaults.set(pokemonText2.text!, forKey: "BoulderImage2")
        defaults.set(pokemonText3.text!, forKey: "BoulderImage3")
        defaults.set(pokemonText4.text!, forKey: "BoulderImage4")
        defaults.set(pokemonText5.text!, forKey: "BoulderImage5")
        defaults.set(pokemonText6.text!, forKey: "BoulderImage6")
