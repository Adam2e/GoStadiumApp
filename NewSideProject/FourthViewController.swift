...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/tempest-cup")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "TempestImage1")
        defaults.set(pokemonText2.text!, forKey: "TempestImage2")
        defaults.set(pokemonText3.text!, forKey: "TempestImage3")
        defaults.set(pokemonText4.text!, forKey: "TempestImage4")
        defaults.set(pokemonText5.text!, forKey: "TempestImage5")
        defaults.set(pokemonText6.text!, forKey: "TempestImage6")
