...
class SixViewController: ViewController {
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/nightmare-cup")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "NightmareImage1")
        defaults.set(pokemonText2.text!, forKey: "NightmareImage2")
        defaults.set(pokemonText3.text!, forKey: "NightmareImage3")
        defaults.set(pokemonText4.text!, forKey: "NightmareImage4")
        defaults.set(pokemonText5.text!, forKey: "NightmareImage5")
        defaults.set(pokemonText6.text!, forKey: "NightmareImage6")
