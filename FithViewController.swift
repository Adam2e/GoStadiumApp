...
class FithViewController: ViewController
{
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/kingdom-cup")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "KingdomImage1")
        defaults.set(pokemonText2.text!, forKey: "KingdomImage2")
        defaults.set(pokemonText3.text!, forKey: "KingdomImage3")
        defaults.set(pokemonText4.text!, forKey: "KingdomImage4")
        defaults.set(pokemonText5.text!, forKey: "KingdomImage5")
        defaults.set(pokemonText6.text!, forKey: "KingdomImage6")
