...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/cup/fusion")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "FusionImage1")
        defaults.set(pokemonText2.text!, forKey: "FusionImage2")
        defaults.set(pokemonText3.text!, forKey: "FusionImage3")
        defaults.set(pokemonText4.text!, forKey: "FusionImage4")
        defaults.set(pokemonText5.text!, forKey: "FusionImage5")
        defaults.set(pokemonText6.text!, forKey: "FusionImage6")
