...
class EightViewController: ViewController {
...
//    }
   @IBAction func linkClicked(sender: AnyObject) {
             openUrl(urlStr: "https://silph.gg/cup/jungle")
    }
...
func saveUserDefaults()
        ...
        let defaults = UserDefaults.standard
        defaults.set(pokemonText1.text!, forKey: "JungleImage1")
        defaults.set(pokemonText2.text!, forKey: "JungleImage2")
        defaults.set(pokemonText3.text!, forKey: "JungleImage3")
        defaults.set(pokemonText4.text!, forKey: "JungleImage4")
        defaults.set(pokemonText5.text!, forKey: "JungleImage5")
        defaults.set(pokemonText6.text!, forKey: "JungleImage6")
